...
DEFINE_STRUCT_SCHEMA(climb_config, 
...
DEFINE_STRUCT_SCHEMA(climb_info::boxes, 
...
DEFINE_STRUCT_SCHEMA(climb_info, 
    DEFINE_STRUCT_FIELD(climb_list, "climb_list"),
    DEFINE_STRUCT_FIELD(normal_list, "normal_list")
    );

struct climb_detect_info_result {
    climb_info detect_info;
};

DEFINE_STRUCT_SCHEMA(climb_detect_info_result, 
...
DEFINE_STRUCT_SCHEMA(climb_new_param,
    DEFINE_STRUCT_FIELD(device, "device"), 
...
struct climb_detect_param {
  ...
  //检测入参
DEFINE_STRUCT_SCHEMA(climb_detect_param, 
    DEFINE_STRUCT_FIELD(algo_params, "algo_params"),
    DEFINE_STRUCT_FIELD(data_params, "data_params"));

DEFINE_STRUCT_SCHEMA(climb_detect_param::optional_params, 
    DEFINE_STRUCT_FIELD(dyparams, "dyparams"));

DEFINE_STRUCT_SCHEMA(climb_detect_param::optional_params::dyparams_params, 
    DEFINE_STRUCT_FIELD(conf_thres, "conf_thres") ,
    DEFINE_STRUCT_FIELD(nms_thres, "nms_thres"));

DEFINE_STRUCT_SCHEMA(climb_detect_param::basic_params, 
