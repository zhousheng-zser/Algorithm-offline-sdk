...
namespace glasssix {
    ...
    gx_pedestrian_min_api::gx_pedestrian_min_api(const std::string& config_path) : impl_{std::make_unique<impl>(config_path)} {}
        ...
        pedestrian_min_info safe_production_pedestrian_min(const gx_img_api& mat) {
            try {
                auto result_pool = pool->enqueue([&] {
                    ...
                    nlohmann::json execute_json(pedestrian_min_detect_param{
                        .algo_params =
                            pedestrian_min_detect_param::optional_params{.dyparams =
                                                                   pedestrian_min_detect_param::optional_params::dyparams_params{
                                                                       .conf_thres = _config->_pedestrian_min_config.conf_thres,
                                                                       .nms_thres  = _config->_pedestrian_min_config.nms_thres}},
                        .data_params =
                            pedestrian_min_detect_param::basic_params{.height = mat.get_rows(), .width = mat.get_cols()}
                ...
                bool flag = write_dump_img(mat, "_pedestrian_min_dump.jpg", _config->_configure_directory.dump_img_directory);
    ...
    private:
        ...
        std::string empower_algorithm_version = share_platform_name + "_" + share_empower_language + "_pedestrian_min_V3.0.0";
    ...
    pedestrian_min_info gx_pedestrian_min_api::safe_production_pedestrian_min(const gx_img_api& mat) {
        ...
        return impl_->safe_production_pedestrian_min(mat);
    }
