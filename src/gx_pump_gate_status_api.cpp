...
std::vector<pump_gate_room_info> rooms_list = {
    pump_gate_room_info{20051102, 40230255, 15013051, 45038115, {720, 206, 777, 255}, {980, 915, 1260, 1010}, 0.16,0.04 ,0.15 },//10
    pump_gate_room_info{20051102, 40230255, 110038077, 130089140, {713, 218, 775, 269}, {890, 1003, 963, 1080},0.04 , 0.01,0.10 },//11
    pump_gate_room_info{20051102, 40230255, 105051102, 145128166, {750, 210, 811, 261}, {936, 1000, 1008, 1080},0.09 , 0.04, 0.10},//12
...
namespace glasssix {
    ...
    private:
        ...
        std::string empower_algorithm_id =
            share_platform_name + "_" + share_empower_language + "_PUMP_GATE_STATUS_V1.1.1";
