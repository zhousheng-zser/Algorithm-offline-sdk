...
namespace glasssix {
    ...
    gx_pump_glove_api::gx_pump_glove_api() : impl_{std::make_unique<impl>()} {}
    gx_pump_glove_api::gx_pump_glove_api(const abi::string& config_path) : impl_{std::make_unique<impl>(config_path)} {}
    gx_pump_glove_api::~gx_pump_glove_api() {}
    gx_pump_glove_api::gx_pump_glove_api(gx_pump_glove_api&&) noexcept            = default;
    gx_pump_glove_api& gx_pump_glove_api::operator=(gx_pump_glove_api&&) noexcept = default;
    class gx_pump_glove_api::impl {
    public:
        void init() {
#if (GX_EMPOWER_FLAG)  
    ...
    private:
        ...
        std::string empower_algorithm_version = share_platform_name + "_" + share_empower_language + "_PUMP_GLOVE_V1.0.0";
    ...
    //  手套检测
    pump_glove_info gx_pump_glove_api::safe_production_pump_glove(const gx_img_api& mat) {
        try {
...
#endif
                auto result = ptr->protocol_ptr.invoke<pump_glove::detect>(ptr->pump_glove_handle,
                    pump_glove_detect_param{.instance_guid = "",
                        .format                            = _config->_pump_glove_config.format,
                        .height                            = mat.get_rows(),
                        .width                             = mat.get_cols(),
                        .roi_x                             = 0,
                        .roi_y                             = 0,
                        ...
                        .params =
                            pump_glove_detect_param::confidence_params{
                                .hand_conf_thres = _config->_pump_glove_config.hand_conf_thres,
                                .conf_thres      = _config->_pump_glove_config.conf_thres,
                                .nms_thres       = _config->_pump_glove_config.nms_thres}},
                    str);
            ...
            bool flag = write_dump_img(mat, "_pump_glove_dump.jpg");
