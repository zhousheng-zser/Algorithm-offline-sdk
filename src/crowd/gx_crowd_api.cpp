...
namespace glasssix {
    ...
    public:
        ...
        algo_ptr() {
            try {
                ...
                nlohmann::json new_json(crowd_new_param{.device = _config->_crowd_config.device,
                    .models_directory            = _config->_configure_directory.models_directory});
                char* new_result_c = parser_create_instance("g6.crowd.detect_code", new_json.dump().c_str());
    ...
    gx_crowd_api::gx_crowd_api(const std::string& config_path) : impl_{std::make_unique<impl>(config_path)} {}
    ...
    public:
        ...
        ~impl() {}
        crowd_info safe_production_crowd(
            ...
            try {
                auto result_pool = pool->enqueue([&] {
                    ...
                    nlohmann::json execute_json(crowd_detect_param{
                        .algo_params =
                            crowd_detect_param::optional_params{.dyparams =
                                                                   crowd_detect_param::optional_params::dyparams_params{.min_cluster_size =
                                                                                                     min_cluster_size,
                        ...
                        .device_id =device_id}},
                        .data_params =
                            crowd_detect_param::basic_params{.height = mat.get_rows(), .width = mat.get_cols()}
                    ...
                    ans = std::move(json::parse(execute_result.result).get<crowd_detect_info_result>().detect_info);
                    return ans;
                });
                return result_pool.get();
            } catch (const std::exception& ex) {
                bool flag = write_dump_img(mat, "_crowd_dump.jpg", _config->_configure_directory.dump_img_directory);
    ...
    crowd_info gx_crowd_api::safe_production_crowd(
        ...
        return impl_->safe_production_crowd(mat, min_cluster_size, trigger_delay, device_id);
    }
