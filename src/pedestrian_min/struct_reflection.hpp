...
DEFINE_STRUCT_SCHEMA(pedestrian_min_config, 
  ...
  //行人框体
DEFINE_STRUCT_SCHEMA(pedestrian_min_info::boxes, 
...
DEFINE_STRUCT_SCHEMA(pedestrian_min_info, 
    DEFINE_STRUCT_FIELD(person_list, "person_list")
    );

struct pedestrian_min_detect_info_result {
    pedestrian_min_info detect_info;
};

DEFINE_STRUCT_SCHEMA(pedestrian_min_detect_info_result, 
    DEFINE_STRUCT_FIELD(detect_info, "detect_info"));


// new 
struct pedestrian_min_new_param {
    int device;
    std::string models_directory;
};


DEFINE_STRUCT_SCHEMA(pedestrian_min_new_param,
    DEFINE_STRUCT_FIELD(device, "device"), 
    DEFINE_STRUCT_FIELD(models_directory, "models_directory"));

// detect
struct pedestrian_min_detect_param {
  ...
  //检测入参
DEFINE_STRUCT_SCHEMA(pedestrian_min_detect_param, 
    DEFINE_STRUCT_FIELD(algo_params, "algo_params"),
    DEFINE_STRUCT_FIELD(data_params, "data_params"));

DEFINE_STRUCT_SCHEMA(pedestrian_min_detect_param::optional_params, 
    DEFINE_STRUCT_FIELD(dyparams, "dyparams"));

DEFINE_STRUCT_SCHEMA(pedestrian_min_detect_param::optional_params::dyparams_params, 
    DEFINE_STRUCT_FIELD(conf_thres, "conf_thres") ,
    DEFINE_STRUCT_FIELD(nms_thres, "nms_thres"));

DEFINE_STRUCT_SCHEMA(pedestrian_min_detect_param::basic_params, 
