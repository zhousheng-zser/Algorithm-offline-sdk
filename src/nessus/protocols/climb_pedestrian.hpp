...
namespace glasssix {
    struct climb_pedestrian_new_param {
        GX_BEGIN_FIELDS(climb_pedestrian_new_param);
    ...
    struct climb_pedestrian_detect_param {
        ...
        GX_BEGIN_FIELDS(climb_pedestrian_detect_param);
    ...
    struct climb_pedestrian_detect_result {
        GX_BEGIN_FIELDS(climb_pedestrian_detect_result);
    ...
    struct climb_pedestrian : protocol_object {
        struct detect : parser_inout<climb_pedestrian_detect_param, climb_pedestrian_detect_result> {};
    };
} // namespace glasssix
