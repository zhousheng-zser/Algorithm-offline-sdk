...
namespace glasssix {
    ...
    struct climb_tumble_info {
        ...
        GX_BEGIN_FIELDS(climb_tumble_info);

        GX_FIELD(abi::vector<boxes>, persion_list); // 正常状态的人
        GX_FIELD(abi::vector<boxes>, climb_list); // 攀爬的人
        GX_FIELD(abi::vector<boxes>, tumble_list); // 跌倒的人
        GX_FIELD(abi::vector<boxes>, disabled_list); // 残缺
        GX_FIELD(abi::vector<boxes>, other_list); // 其他
        GX_END_FIELDS;
