...
DEFINE_STRUCT_SCHEMA(pump_mask_config, 
...
DEFINE_STRUCT_SCHEMA(pump_mask_info::boxes, 
...
DEFINE_STRUCT_SCHEMA(pump_mask_info, 
    DEFINE_STRUCT_FIELD(pump_head_list, "pump_head_list")
    );

struct pump_mask_detect_info_result {
    pump_mask_info detect_info;
};

DEFINE_STRUCT_SCHEMA(pump_mask_detect_info_result, 
...
DEFINE_STRUCT_SCHEMA(pump_mask_new_param,
    DEFINE_STRUCT_FIELD(device, "device"), 
...
struct pump_mask_detect_param {
  ...
  //检测入参
DEFINE_STRUCT_SCHEMA(pump_mask_detect_param, 
    DEFINE_STRUCT_FIELD(algo_params, "algo_params"),
    DEFINE_STRUCT_FIELD(data_params, "data_params"));

DEFINE_STRUCT_SCHEMA(pump_mask_detect_param::optional_params, 
    DEFINE_STRUCT_FIELD(dyparams, "dyparams"));

DEFINE_STRUCT_SCHEMA(pump_mask_detect_param::optional_params::dyparams_params, 
    DEFINE_STRUCT_FIELD(conf_thres, "conf_thres") ,
    DEFINE_STRUCT_FIELD(nms_thres, "nms_thres"));

DEFINE_STRUCT_SCHEMA(pump_mask_detect_param::basic_params, 
