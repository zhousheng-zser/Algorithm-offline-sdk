...
#include "../../../include/g6/info_pump_cover_plate.hpp"
...
namespace glasssix {
    struct pump_cover_plate_new_param {
        GX_BEGIN_FIELDS(pump_cover_plate_new_param);
    ...
    struct pump_cover_plate_detect_param {
        ...
        GX_BEGIN_FIELDS(pump_cover_plate_detect_param);
    ...
    struct pump_cover_plate_detect_result {
        GX_BEGIN_FIELDS(pump_cover_plate_detect_result);
        GX_FIELD(parser_result_status, status);
        GX_FIELD(pump_cover_plate_info, detect_info);
        GX_END_FIELDS;
        GX_JSON_SERIALIZABLE(naming_convention::lower_case_with_underscores);
    };

    struct pump_cover_plate : protocol_object {
        struct detect : parser_inout<pump_cover_plate_detect_param, pump_cover_plate_detect_result> {};
    };
} // namespace glasssix
