...
DEFINE_STRUCT_SCHEMA(vehicle_config, 
...
DEFINE_STRUCT_SCHEMA(vehicle_info::boxes, 
    ...
    DEFINE_STRUCT_FIELD(x3, "x3"),
    DEFINE_STRUCT_FIELD(y3, "y3"), 
    DEFINE_STRUCT_FIELD(x4, "x4"), 
    DEFINE_STRUCT_FIELD(y4, "y4"), 
    DEFINE_STRUCT_FIELD(x5, "x5"), 
    DEFINE_STRUCT_FIELD(y5, "y5")
    );

DEFINE_STRUCT_SCHEMA(vehicle_info, 
    DEFINE_STRUCT_FIELD(vehicle_list, "vehicle_list")
    );

struct vehicle_detect_info_result {
    vehicle_info detect_info;
};

DEFINE_STRUCT_SCHEMA(vehicle_detect_info_result, 
...
DEFINE_STRUCT_SCHEMA(vehicle_new_param,
    DEFINE_STRUCT_FIELD(device, "device"), 
...
struct vehicle_detect_param {
  ...
  //检测入参
DEFINE_STRUCT_SCHEMA(vehicle_detect_param, 
    DEFINE_STRUCT_FIELD(algo_params, "algo_params"),
    DEFINE_STRUCT_FIELD(data_params, "data_params"));

DEFINE_STRUCT_SCHEMA(vehicle_detect_param::optional_params, 
    DEFINE_STRUCT_FIELD(dyparams, "dyparams"));

DEFINE_STRUCT_SCHEMA(vehicle_detect_param::optional_params::dyparams_params, 
    DEFINE_STRUCT_FIELD(conf_thres, "conf_thres") ,
    DEFINE_STRUCT_FIELD(nms_thres, "nms_thres"));

DEFINE_STRUCT_SCHEMA(vehicle_detect_param::basic_params, 
