...
namespace glasssix {
    ...
    gx_pump_cover_plate_api::gx_pump_cover_plate_api() : impl_{std::make_unique<impl>()} {}
    gx_pump_cover_plate_api::gx_pump_cover_plate_api(const abi::string& config_path) : impl_{std::make_unique<impl>(config_path)} {}
    gx_pump_cover_plate_api::~gx_pump_cover_plate_api() {}
    gx_pump_cover_plate_api::gx_pump_cover_plate_api(gx_pump_cover_plate_api&&) noexcept            = default;
    gx_pump_cover_plate_api& gx_pump_cover_plate_api::operator=(gx_pump_cover_plate_api&&) noexcept = default;
    class gx_pump_cover_plate_api::impl {
    public:
        void init() {
#if (GX_EMPOWER_FLAG)  
    ...
    private:
        ...
        std::string empower_algorithm_version =
            share_platform_name + "_" + share_empower_language + "_pump_cover_plate_V2.0.0";
    ...
    //  泵业地盖未盖盖检测
    pump_cover_plate_info gx_pump_cover_plate_api::safe_production_pump_cover_plate(
        ...
        try {
...
#endif
                auto result = ptr->protocol_ptr.invoke<pump_cover_plate::detect>(ptr->pump_cover_plate_handle,
                    pump_cover_plate_detect_param{.instance_guid = "",
                        .format                                  = _config->_pump_cover_plate_config.format,
                        .height                                  = mat.get_rows(),
                        .width                                   = mat.get_cols(),
                        .roi_x                                   = 0,
                        .roi_y                                   = 0,
                        ...
                        .params = pump_cover_plate_detect_param::confidence_params{.x1 = quadrangle[0].x,
                            .y1                                                        = quadrangle[0].y,
                            .x2                                                        = quadrangle[1].x,
                            .y2                                                        = quadrangle[1].y,
                            .x3                                                        = quadrangle[2].x,
            ...
            bool flag = write_dump_img(mat, "_pump_cover_plate_dump.jpg");
