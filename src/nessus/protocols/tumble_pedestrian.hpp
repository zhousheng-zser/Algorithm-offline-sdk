...
namespace glasssix {
    struct tumble_pedestrian_new_param {
        GX_BEGIN_FIELDS(tumble_pedestrian_new_param);
    ...
    struct tumble_pedestrian_detect_param {
        ...
        GX_BEGIN_FIELDS(tumble_pedestrian_detect_param);
    ...
    struct tumble_pedestrian : protocol_object {
        struct detect : parser_inout<tumble_pedestrian_detect_param, tumble_pedestrian_detect_result> {};
    };
} // namespace glasssix
