...
namespace glasssix {
    ...
    private:
        ...
        std::string empower_algorithm_version =
            share_platform_name + "_" + share_empower_language + "_PEDESTRIAN_V4.1.0";
    ...
    pedestrian_info gx_pedestrian_api::safe_production_pedestrian(const gx_img_api& mat) {
        try {
            auto result_pool = pool->enqueue(100,[&] {
                ...
                auto result = ptr->protocol_ptr.invoke<pedestrian::detect>(ptr->pedestrian_handle,
                    pedestrian_detect_param{.instance_guid = "",
                        ...
                        .params                            = pedestrian_detect_param::confidence_params{.conf_thres =
                                                                                 _config->_pedestrian_config.conf_thres,
            ...
            bool flag = write_dump_img(mat, "_pedestrian_dump.jpg");
