...
namespace glasssix {
    ...
    gx_tumble_pedestrian_api::gx_tumble_pedestrian_api(gx_tumble_pedestrian_api&&) noexcept            = default;
    gx_tumble_pedestrian_api& gx_tumble_pedestrian_api::operator=(gx_tumble_pedestrian_api&&) noexcept = default;
    class gx_tumble_pedestrian_api::impl {
    public:
        void init() {
            if (pool_tumble_pedestrian == nullptr)
                pool_tumble_pedestrian = new thread_pool(_config->_configure_directory.thread_pool_num_tumble_pedestrian);
            if (api_temp == nullptr) {
    ...
    private:
        ...
        std::string empower_algorithm_version = share_platform_name + "_" + share_empower_language + "_TUMBLE_PEDESTRIAN_V1.0.0";
    ...
    tumble_info gx_tumble_pedestrian_api::safe_production_tumble_pedestrian(
        ...
        try {
...
#endif
                auto result = ptr->protocol_ptr.invoke<tumble_pedestrian::detect>(ptr->tumble_pedestrian_handle,
                    tumble_pedestrian_detect_param{.instance_guid = "",
                        .format                        = _config->_tumble_pedestrian_config.format,
                        .height                        = mat.get_rows(),
                        .width                         = mat.get_cols(),
                        .roi_x                         = 0,
                        .roi_y                         = 0,
                        ...
                        .params =
                            tumble_pedestrian_detect_param::confidence_params{.conf_thres = _config->_tumble_pedestrian_config.conf_thres,
                                .nms_thres                                     = _config->_tumble_pedestrian_config.nms_thres}},
                    str);
            ...
            bool flag = write_dump_img(mat, "_tumble_pedestrian_dump.jpg");
